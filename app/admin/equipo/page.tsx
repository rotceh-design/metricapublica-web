          ...
          {equipo.length === 0 ? (
            ...
            <div className="grid gap-5">
              {equipo.map((integrante) => {
                const imageAspect = integrante.imageAspect || "square";
                      ...
                      <div className="bg-[#08111f] p-4">
                        ...
                        >
                          {integrante.imageUrl ? (
                            ...
                            <div className="flex h-full w-full items-center justify-center text-4xl font-bold text-[#009B8D]">
                              MP
                            </div>
                          )}
                        </div>
                          ...
                          <div>
                            <div className="mb-3 flex flex-wrap gap-2">
                              ...
                              <span className="rounded-full border border-white/10 px-3 py-1 text-xs text-slate-500">
                                {integrante.featured ? "Destacado" : "Normal"}
                              </span>
                            </div>
                            ...
                            <p className="mb-3 wrap-anywhere text-sm font-semibold text-[#009B8D]">
                              {integrante.role}
                            </p>
