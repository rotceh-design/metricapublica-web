...
export default function EditarIntegranteEquipoPage() {
  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, async (currentUser) => {
      ...
      const integrante = await getIntegranteEquipo(id);
      ...
      setForm({
        ...
        imageFit: integrante.imageFit || "cover",
        imagePosition: integrante.imagePosition || "center",
        imageAspect: integrante.imageAspect || "square",
        order: integrante.order || 1,
        active: integrante.active ?? true,
        featured: integrante.featured ?? true,
      });
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await updateIntegranteEquipo(id, {
        ...form,
  ...
  if (checking) {
    return (
      <main className="flex min-h-screen items-center justify-center bg-[#0a1628] text-white">
        <p className="text-slate-400">Cargando integrante...</p>
      </main>
    );
  }
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <h1 className="text-4xl font-bold">Editar integrante</h1>

            <p className="mt-2 max-w-2xl text-slate-400">
              Modifica la fotografía, cargo, biografía, estado y datos públicos
              del integrante.
            </p>
          </div>
          ...
          >
            <div className="mb-8 rounded-2xl border border-[#009B8D]/15 bg-[#08111f]/70 p-5">
              ...
              <p className="mt-2 text-sm text-slate-400">
                Puedes mantener la imagen actual o subir una nueva. La nueva
                foto se optimizará automáticamente antes de guardarse.
              </p>
                  ...
                  <div className="mt-6 flex flex-wrap justify-center gap-3">
                    ...
                    {form.linkedin && (
                      <a
                        ...
                        className="rounded-xl border border-[#009B8D]/30 px-4 py-2 text-sm font-semibold text-[#009B8D] transition hover:bg-[#009B8D]/10"
                      >
                        LinkedIn
                      </a>
                    )}
