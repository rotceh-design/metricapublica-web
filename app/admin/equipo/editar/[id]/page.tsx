...
export default function EditarIntegranteEquipoPage() {
  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, async (currentUser) => {
      ...
      setForm({
        ...
        roleDescription: integrante.roleDescription || "",
        bio: integrante.bio || "",
    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-[#0a1628] text-white">
        <div className="rounded-[2rem] border border-[#009B8D]/15 bg-[#0f2744] p-8 text-center shadow-2xl">
          ...
          <p className="font-semibold text-slate-400">Cargando integrante...</p>
        </div>
      </main>
    );
  }
  ...
  return (
    <AdminEditorShell
      ...
      description="Modifica la fotografía, cargo, descripción del rol, biografía, enlaces, estado y datos públicos del integrante."
