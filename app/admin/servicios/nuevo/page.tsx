...
export default function NuevoServicioPage() {
  ...
  return (
    <AdminEditorShell
      ...
      description="Construye un servicio público con ícono, descripción, beneficios, orden y estado de visibilidad."
    ...
    >
      <form id="new-servicio-form" onSubmit={handleSubmit}>
