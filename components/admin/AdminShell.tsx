...
const pageCopy: Record<string, { title: string; description: string }> = {
  "/admin/dashboard": {
    title: "Dashboard",
    description: "Resumen general del sitio, publicaciones, mensajes y módulos activos.",
  },
  "/admin/noticias": {
    title: "Noticias",
    description:
  ...
  "/admin/sectores": {
    title: "Sectores",
    description: "Administra los sectores visibles en el home y en la página pública.",
  },
  "/admin/contenido": {
    title: "Contenido",
...
export default function AdminPanelShell({ children }: { children: ReactNode }) {
  ...
  return (
    <main className="min-h-screen bg-[#0a1628] text-white">
      <aside className="fixed left-0 top-0 z-40 hidden h-screen w-[286px] border-r border-[#009B8D]/10 bg-[#08111f] px-5 py-5 shadow-[10px_0_40px_rgba(0,0,0,0.25)] lg:flex lg:flex-col">
